...
for (i in 1:length(lab)){
  load(paste0("output_out3mes/", lab[i],".RData"))
...
fwrite(table1, file = "results_out3mes/table_fitting.csv", quote = FALSE, 
       row.names = FALSE) 
...
ggsave(month.effect.canton, 
       filename = paste0("results_out3mes/",selected.model,".month.effect.canton.jpg"), 
       height = 20, width = 20)
...
ggsave(canton.effect, 
       filename = paste0("results_out3mes/",selected.model,".canton.effect.jpg"), 
...
ggsave(prediction.in, 
       filename = paste0("results_out3mes/",selected.model,".prediction.Case.in.jpg"), 
       height = 20, width = 20)
...
ggsave(prediction.out, 
       filename = paste0("results_out3mes/",selected.model,".prediction.Case.out.jpg"), 
       height = 20, width = 20)
...
ggsave(prediction.in, 
       filename = paste0("results_out3mes/",selected.model,".prediction.RR.in.jpg"), 
       height = 20, width = 20)
...
ggsave(prediction.out, 
       filename = paste0("results_out3mes/",selected.model,".prediction.RR.out.jpg"), 
       height = 20, width = 20)
